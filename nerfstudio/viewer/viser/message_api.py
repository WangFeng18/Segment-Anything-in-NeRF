...
class MessageApi(abc.ABC):
    ...
    def use_sam(self, use_sam: bool) -> None:
        self._queue(messages.SamMessage(use_sam))

    def clear_sam_pins(self) -> None:
        self._queue(messages.ClearSamPinsMessage())

    def update_text_prompt(self, text_prompt: str) -> None:
        self._queue(messages.TextPromptMessage(text_prompt))

    def update_threshold(self, threshold: float) -> None:
        self._queue(messages.ThresholdMessage(threshold))
